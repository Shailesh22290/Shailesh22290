...
🎓 **Currently:** Undergraduate at IISER Bhopal pursuing Data Science & Engineering (CPI: 7.21/10)
🔬 **Research:** ML for Climate Prediction (IIT Delhi) | VR-Biometrics-NLP for Urban Safety (IISER Bhopal)
...
- 🌦️ **ML Research** - Automated stopping-point detection for monsoon prediction at IIT Delhi
- 🏙️ **VR Safety Research** - LSTM-based threat prediction model for urban planning applications
- 💻 **Election Management System** - Full-stack application with Docker deployment
- 🚗 **Vehicle Recognition** - 94% accuracy license plate detection using OpenCV & Deep Learning

🏆 **Recent Achievements**
- 🥇 **1st Place** - Smart India Hackathon 2023 (National Level Competition)
- 🎯 **AIR 7288** - JEE Advanced 2022 (Top 1% among 1.5M candidates)
- 👨‍💼 **General Secretary** - Technical Affairs, Student Activity Council (2024-25)

🌱 I'm currently learning 
- **Advanced ML:** Deep Learning, Computer Vision, NLP with Graphs
- **Research:** Quantum Computing, 3D Deep Learning 
